...
folders = ["resultado3/ReA", "resultado3/AbsA", "resultado3/2DReA", "resultado3/3DAbsA", "resultado3/3DReA"]
...
for tau in taus:
    ...
    plt.tight_layout()
    plt.savefig(f"resultado3/ReA/ReA_tau_{tau:.2f}.png")
    plt.close()
    ...
    plt.grid()
    plt.tight_layout()
    plt.savefig(f"resultado3/AbsA/AbsA_tau_{tau:.2f}.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f"resultado3/2DReA/2DReA_tau_{tau:.2f}.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(f"resultado3/3DAbsA/3DAbsA_tau_{tau:.2f}.png")
    plt.close()
    ...
    fig.colorbar(scatter, ax=ax)
    plt.tight_layout()
    plt.savefig(f"resultado3/3DReA/3DReA_tau_{tau:.2f}.png")
    plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("resultado3/maxAbsA_vs_tau.png")
plt.show()
